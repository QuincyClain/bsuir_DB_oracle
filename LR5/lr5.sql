...
CREATE TABLE table3_audit (
    ...
    testcolumn      VARCHAR2(20),
    id_row          NUMBER NOT NULL
);

ALTER TABLE TABLE1 ADD testcolumn VARCHAR(50);
...
ALTER TABLE TABLE2 ADD testcolumn VARCHAR(50);
...
ALTER TABLE TABLE3 ADD testcolumn VARCHAR(50);
...
-- Вставка записи в TABLE1
INSERT INTO TABLE1 (ID, COLUMN1, testcolumn) VALUES (5, 'Value1', 'TestValue1');

-- Обновление записи в TABLE1
UPDATE TABLE1 SET COLUMN1 = 'Value2' WHERE ID = 5;
...
INSERT INTO TABLE1 (ID, COLUMN1, testcolumn) VALUES (1, 'TestValue1', 'TestValue2');
INSERT INTO TABLE2 (ID, COLUMN1, TABLE1_FK, testcolumn) VALUES (1, SYSDATE, 1, 'TestValue2');


-- Вставка записи в TABLE2
INSERT INTO TABLE2 (ID, COLUMN1, TABLE1_FK, testcolumn) VALUES (1, SYSDATE, 1, 'TestValue2');

-- Обновление записи в TABLE2
UPDATE TABLE2 SET COLUMN1 = SYSDATE WHERE ID = 1;

-- Удаление записи из TABLE2
...
WHEN 'DELETE' THEN
DBMS_OUTPUT.put_line('INSERT INTO TABLE1(id, testcolumn) VALUES (' || audit_row.id_row || ', ' ||
...
INSERT INTO TABLE1 (ID, COLUMN1, testcolumn) VALUES (2, 'ssValue1', 'TestValue1');
...
begin
   restore_table1(TO_TIMESTAMP('2023-05-05 12:12:39.220000000', 'YYYY-MM-DD HH24:MI:SS.FF'));
end;
...
create or replace package restore_pkg as
  procedure db_back(rollback_timestamp in timestamp, table_names string_array);
  procedure db_rollback(rollback_millisecond in number, table_names string_array);
end restore_pkg;
...
DECLARE
  html_document VARCHAR2(32767);
BEGIN
  html_document := html_create(string_array('TABLE1'), SYSTIMESTAMP - INTERVAL '1' HOUR);
  DBMS_OUTPUT.put_line(html_document);
END;